...
#include "nesmem.h"
#define nes6502_getbyte(n) nes_mem_read(NULL, n)

#include "nes.h"
#define nes6502_getcycles(n) nes_cycles_elapsed()
#define nes6502_setdma(n) nes_burn_cycles(n)
#define nes6502_irq() nes_assert_irq()

/* End: Added for CrabEmu */
